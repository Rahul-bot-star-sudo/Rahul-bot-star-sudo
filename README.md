...
<h3 align="center">
🚀 Full Stack Developer | Backend-Focused | System Design Learner
</h3>
...
const rahul = {
  ...
  learning: ["DSA", "System Design", "Clean Architecture"],
  mindset: "Build → Break → Learn → Repeat"
};

💡 I enjoy building scalable backend systems, designing clean APIs,
and gradually moving towards system design & architecture.
...
🔹 E-Commerce Backend – APIs, DB design
